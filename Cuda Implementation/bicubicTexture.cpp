...
void display()
{
	...
	// Update after render - Collisions before render
	if (gravityOn == false)
		positionsUpdate();
	else
		gravityEngaged();
...
void initialize(int argc, char **argv)
{
    ...
    printf("\n"
           ...
           "\tPress number keys to change colour mode:\n\n"
           "\t1 : \n"
           "\t2 : \n"
           "\t3 : \n"
           "\t4 : \n"
...
void initGL(int *argc, char **argv)
{
    ...
    glutCreateWindow("CUDA implementation");
